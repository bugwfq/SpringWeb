...
<center>
<div class="con_title">
<span class="con_title_sp">${news.title}</span>
</div>
<div class="con_date">
<span class="con_title_sp"><font color="black" size="3">各地新闻           经济参考报               ${news.writerDate}</font> </span>
</div><br/>
<div class="con_panel">
<font color="black" size="2">${news.content}</font> 
